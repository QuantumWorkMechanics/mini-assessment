...
const resultsList = [
  ...
  },
  {
    type: "workforce planning",
    starting:
      "Organizations with a starting level of workforce maturity have no formal workforce planning or strategy. They react to problems or requests as they arise, without considering the long-term implications or goals. They lack the tools, data, and skills to assess their current and future workforce needs. They often face challenges such as high turnover, low productivity, skill gaps, and poor alignment with organizational objectives. They need to improve their workforce maturity by implementing a systematic and proactive approach to workforce planning.",
    developing:
      "Organizations with a developing level of workforce maturity have some basic planning and strategy for their workforce development, but they are not consistent or comprehensive. They use some tools, data, and skills to assess their current and future workforce needs, but they are not integrated or aligned. They face some challenges such as moderate turnover, average productivity, skill mismatches, and partial alignment with organizational objectives. They need to improve their workforce maturity by implementing a more systematic and proactive approach to workforce planning",
    intermediate:
      "Organizations with an intermediate level of workforce maturity have a clear planning and strategy for their workforce development, but they are not fully implemented or optimized. They use various tools, data, and skills to assess their current and future workforce needs, but they are not fully integrated or aligned. They face few challenges such as low turnover, high productivity, skill matches, and strong alignment with organizational objectives. They need to improve their workforce maturity by implementing a more advanced and proactive approach to workforce planning.",
    advanced:
      "Organizations with an advanced level of workforce maturity have a comprehensive planning and strategy for their workforce development, and they are fully implemented and optimized. They use sophisticated tools, data, and skills to assess their current and future workforce needs, and they are fully integrated and aligned. They face minimal challenges such as very low turnover, very high productivity, skill excellence, and optimal alignment with organizational objectives. They need to maintain their workforce maturity by implementing a continuous and proactive approach to workforce planning.",
  },
  {
    type: "extended workforce",
    starting:
      "Organizations with a starting level of MSP program maturity have no formal MSP program or strategy. They rely on external workers as a last resort, without considering the strategic benefits or risks. They lack the tools, data, and skills to manage and orchestrate their external workforce. They often face challenges such as compliance issues, quality problems, security breaches, and misalignment with organizational objectives. They need to improve their MSP program maturity by implementing a framework for orchestrating workforce ecosystems [^1^][1].",
    developing:
      "Organizations with a developing level of MSP program maturity have some basic MSP program or strategy, but they are not consistent or comprehensive. They use external workers as a tactical solution, without considering the long-term implications or goals. They use some tools, data, and skills to manage and orchestrate their external workforce, but they are not integrated or aligned. They face some challenges such as legal and compliance considerations, integration architectures, performance management, and inclusion and engagement of external workers [^2^][2]. They need to improve their MSP program maturity by implementing a more systematic and proactive approach to MSP program planning [^3^][3].",
    intermediate:
      "Organizations with an intermediate level of MSP program maturity have a clear MSP program or strategy, but they are not fully implemented or optimized. They use external workers as a strategic lever, but they are not fully leveraging their potential or value. They use various tools, data, and skills to manage and orchestrate their external workforce, but they are not fully integrated or aligned. They face few challenges such as talent sourcing, workforce planning, collaboration and communication, and compensation and rewards [^3^][3]. They need to improve their MSP program maturity by implementing a more advanced and proactive approach to MSP program planning [^4^][4].",
    advanced:
      "Organizations with an advanced level of MSP program maturity have a comprehensive MSP program or strategy, and they are fully implemented and optimized. They use external workers as a competitive advantage, and they are fully harnessing their capabilities and contributions. They use sophisticated tools, data, and skills to manage and orchestrate their external workforce, and they are fully integrated and aligned. They face minimal challenges such as governance and risk management, innovation and learning, culture and diversity, and advocacy and sustainability [^4^][4]. They need to maintain their MSP program maturity by implementing a continuous and proactive approach to MSP program planning [^5^][5].",
  },
  {
    type: "talent acquisition",
    starting:
      "Organizations with a starting level of talent acquisition maturity have no formal talent acquisition planning or strategy. They react to hiring needs as they arise, without considering the long-term implications or goals. They lack the tools, data, and skills to source, recruit, and hire the best talent for their organization. They often face challenges such as high turnover, low productivity, skill gaps, and poor alignment with organizational objectives. They need to improve their talent acquisition maturity by implementing a systematic and proactive approach to talent acquisition [^1^][1].",
    developing:
      "Organizations with a developing level of talent acquisition maturity have some basic talent acquisition planning or strategy, but they are not consistent or comprehensive. They use talent acquisition as a tactical solution, without considering the strategic benefits or risks. They use some tools, data, and skills to source, recruit, and hire talent, but they are not integrated or aligned. They face some challenges such as legal and compliance considerations, integration architectures, performance management, and inclusion and engagement of talent [^2^][2]. They need to improve their talent acquisition maturity by implementing a more systematic and proactive approach to talent acquisition [^3^][3].",
    intermediate:
      "Organizations with an intermediate level of talent acquisition maturity have a clear talent acquisition planning or strategy, but they are not fully implemented or optimized. They use talent acquisition as a strategic lever, but they are not fully leveraging its potential or value. They use various tools, data, and skills to source, recruit, and hire talent, but they are not fully integrated or aligned. They face few challenges such as talent sourcing, workforce planning, collaboration and communication, and compensation and rewards [^3^][3]. They need to improve their talent acquisition maturity by implementing a more advanced and proactive approach to talent acquisition [^4^][4].",
    advanced:
      "Organizations with an advanced level of talent acquisition maturity have a comprehensive talent acquisition planning or strategy, and they are fully implemented and optimized. They use talent acquisition as a competitive advantage, and they are fully harnessing its capabilities and contributions. They use sophisticated tools, data, and skills to source, recruit, and hire talent, and they are fully integrated and aligned. They face minimal challenges such as governance and risk management, innovation and learning, culture and diversity, and advocacy and sustainability [^4^][4]. They need to maintain their talent acquisition maturity by implementing a continuous and proactive approach to talent acquisition [^5^][5].",
  },
  {
    type: "talent management",
    starting:
      "Organizations with a starting level of talent management maturity have no formal talent management planning or strategy. They react to talent needs as they arise, without considering the long-term implications or goals. They lack the tools, data, and skills to develop, engage, and retain the best talent for their organization. They often face challenges such as high turnover, low productivity, skill gaps, and poor alignment with organizational objectives. They need to improve their talent management maturity by implementing a systematic and proactive approach to talent management [^1^][1].",
    developing:
      "Organizations with a developing level of talent management maturity have some basic talent management planning or strategy, but they are not consistent or comprehensive. They use talent management as a tactical solution, without considering the strategic benefits or risks. They use some tools, data, and skills to develop, engage, and retain talent, but they are not integrated or aligned. They face some challenges such as legal and compliance considerations, integration architectures, performance management, and inclusion and engagement of talent [^2^][2]. They need to improve their talent management maturity by implementing a more systematic and proactive approach to talent management [^3^][3].",
    intermediate:
      "Organizations with an intermediate level of talent management maturity have a clear talent management planning or strategy, but they are not fully implemented or optimized. They use talent management as a strategic lever, but they are not fully leveraging its potential or value. They use various tools, data, and skills to develop, engage, and retain talent, but they are not fully integrated or aligned. They face few challenges such as talent sourcing, workforce planning, collaboration and communication, and compensation and rewards [^3^][3]. They need to improve their talent management maturity by implementing a more advanced and proactive approach to talent management [^4^][4].",
    advanced:
      "Organizations with an advanced level of talent management maturity have a comprehensive talent management planning or strategy, and they are fully implemented and optimized. They use talent management as a competitive advantage, and they are fully harnessing its capabilities and contributions. They use sophisticated tools, data, and skills to develop, engage, and retain talent, and they are fully integrated and aligned. They face minimal challenges such as governance and risk management, innovation and learning, culture and diversity, and advocacy and sustainability [^4^][4]. They need to maintain their talent management maturity by implementing a continuous and proactive approach to talent management .",
  },
  {
    type: "leadership & change",
    starting:
      "Organizations with a starting level of workforce strategy and leadership maturity have no formal workforce strategy or leadership development plan. They react to workforce needs as they arise, without considering the long-term implications or goals. They lack the tools, data, and skills to align, engage, and empower their workforce. They often face challenges such as high turnover, low productivity, skill gaps, and poor alignment with organizational objectives. They need to improve their workforce strategy and leadership maturity by implementing a systematic and proactive approach to workforce development [^1^][1].",
    developing:
      "Organizations with a developing level of workforce strategy and leadership maturity have some basic workforce strategy or leadership development plan, but they are not consistent or comprehensive. They use workforce strategy and leadership development as a tactical solution, without considering the strategic benefits or risks. They use some tools, data, and skills to align, engage, and empower their workforce, but they are not integrated or aligned. They face some challenges such as legal and compliance considerations, integration architectures, performance management, and inclusion and engagement of workforce [^2^][2]. They need to improve their workforce strategy and leadership maturity by implementing a more systematic and proactive approach to workforce development [^3^][3].",
    intermediate:
      "Organizations with an intermediate level of workforce strategy and leadership maturity have a clear workforce strategy or leadership development plan, but they are not fully implemented or optimized. They use workforce strategy and leadership development as a strategic lever, but they are not fully leveraging their potential or value. They use various tools, data, and skills to align, engage, and empower their workforce, but they are not fully integrated or aligned. They face few challenges such as talent sourcing, workforce planning, collaboration and communication, and compensation and rewards [^3^][3]. They need to improve their workforce strategy and leadership maturity by implementing a more advanced and proactive approach to workforce development [^4^][4].",
    advanced:
      "Organizations with an advanced level of workforce strategy and leadership maturity have a comprehensive workforce strategy or leadership development plan, and they are fully implemented and optimized. They use workforce strategy and leadership development as a competitive advantage, and they are fully harnessing their capabilities and contributions. They use sophisticated tools, data, and skills to align, engage, and empower their workforce, and they are fully integrated and aligned. They face minimal challenges such as governance and risk management, innovation and learning, culture and diversity, and advocacy and sustainability [^4^][4]. They need to maintain their workforce strategy and leadership maturity by implementing a continuous and proactive approach to workforce development [^5^][5].",
  },
  {
    type: "workforce productivity",
    starting:
      "Organizations with a starting level of workforce productivity maturity have no formal workforce productivity planning or strategy. They react to productivity issues as they arise, without considering the long-term implications or goals. They lack the tools, data, and skills to measure, improve, and sustain their workforce productivity. They often face challenges such as high turnover, low productivity, skill gaps, and poor alignment with organizational objectives. They need to improve their workforce productivity maturity by implementing a systematic and proactive approach to workforce development [^1^][1].",
    developing:
      "Organizations with a developing level of workforce productivity maturity have some basic workforce productivity planning or strategy, but they are not consistent or comprehensive. They use workforce productivity as a tactical solution, without considering the strategic benefits or risks. They use some tools, data, and skills to measure, improve, and sustain their workforce productivity, but they are not integrated or aligned. They face some challenges such as legal and compliance considerations, integration architectures, performance management, and inclusion and engagement of workforce [^2^][2]. They need to improve their workforce productivity maturity by implementing a more systematic and proactive approach to workforce development [^3^][3].",
    intermediate:
      "Organizations with an intermediate level of workforce productivity maturity have a clear workforce productivity planning or strategy, but they are not fully implemented or optimized. They use workforce productivity as a strategic lever, but they are not fully leveraging its potential or value. They use various tools, data, and skills to measure, improve, and sustain their workforce productivity, but they are not fully integrated or aligned. They face few challenges such as talent sourcing, workforce planning, collaboration and communication, and compensation and rewards [^3^][3]. They need to improve their workforce productivity maturity by implementing a more advanced and proactive approach to workforce development .",
    advanced:
      "Organizations with an advanced level of workforce productivity maturity have a comprehensive workforce productivity planning or strategy, and they are fully implemented and optimized. They use workforce productivity as a competitive advantage, and they are fully harnessing its capabilities and contributions. They use sophisticated tools, data, and skills to measure, improve, and sustain their workforce productivity, and they are fully integrated and aligned. They face minimal challenges such as governance and risk management, innovation and learning, culture and diversity, and advocacy and sustainability . They need to maintain their workforce productivity maturity by implementing a continuous and proactive approach to workforce development .",
  },
  {
    type: "talent management",
    starting:
...
export { questionBank, resultsList };
