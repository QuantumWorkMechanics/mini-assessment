...
//     2: An Array of values to be filtered out.
//     3: The name of the field within the object.
//     4: The name of the new field that those values will be split out to
// Ex:
// const arr =[{items:["oneFish","twoFish","redFish","blueFish"]}]
// let result = splitOut(arr,["oneFish","twoFish"],"items","newItems")
// result: [{items:["oneFish","twoFish","redFish","blueFish"],newItems:["oneFish","twoFish"]}]

export function splitOut(arr, filterArr, field, newField) {
  let tempData = [];
  arr.map((datum) => {
    let tempDatum = { ...datum };
    let tempItems;
...
//         2. The Name of the field containing the Array
//         3. Optional- The name of the new field the values should be expanded to.
//                 If blank, values will be placed in the original field.
//     Ex:
//     const arr = [
//         {val:1,val2:2,val3:["red","blue"]}
//     ]
//    result1 = expandNested (arr,"val3","val4")
//     result1 = [
//          {val:1,val2:2,val3:["red","blue"],val4:"red"},
//          {val:1,val2:2,val3:["red","blue"],val4:"blue"}
//     ]

//     result2 = expandNested (arr,"val3")
//     result2 = [
//          {val:1,val2:2,val3:"blue"},
//          {val:1,val2:2,val3:"red"}
//     ]

export function expandNested(arr, field, newField) {
  let tempResult = [];
  arr.map((item) => {
    if (
...
export function filterData(dataArr, filterArr) {
