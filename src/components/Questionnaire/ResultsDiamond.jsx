...
export default function ResultsDiamond({ components, results }) {
  ...
  return (
    <>
      <SpotlightTour open={open} Spotlight={Spotlight}>
        ...
        ></div> */}
          <div
            className={
              "absolute w-[34.5%] h-[1px]  bottom-[19.5%] left-[5%] " +
        ...
        ></div> */}
          <div
            className={
              "absolute w-[23%] h-[1px] bg-[#FDB517] top-[46%]  right-[5%] " +
              ((rightCircle && "bg-[#FDB517] ") || "bg-slate-400 ")
            }
          ></div>
          {/* <div
        ...
        ></div> */}
          <div
            className={
              "absolute w-[25%] h-[1px] bg-[#FDB517] top-[46%]  left-[5%] " +
              ((leftCircle && "bg-[#FDB517] ") || "bg-slate-400 ")
            }
          ></div>
          <div
          ...
          <div className="absolute w-[15%] h-[25%] bottom-[20%] left-[4%]">
          ...
          <div
            ...
            className={
              " text-[#016AAB] font-bold  cursor-pointer font-lighter absolute  w-[20%] md:w-[18%] top-[12%] left-[5%] leading-tight " +
          ...
          <div
            ...
            className={
              "  font-bold cursor-pointer font-lighter absolute  w-[23%] md:w-[18%] top-[50%] md:top-[46%]  right-[5%] text-right leading-tight  " +
          ...
          <div
            ...
            className={
              "text-[#016AAB] font-bold  cursor-pointer font-lighter absolute  w-[23%] md:w-[18%] top-[81%] left-[5%] leading-tight  " +
