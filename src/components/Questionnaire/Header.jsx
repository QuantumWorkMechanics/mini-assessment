...
export default function Header({ currentQuestion, count, questionIndex }) {
  return (
    <>
      <div className="mt-2  md:-mb-1 md:ml-40  text-slate-600 text-sm md:text-sm">
      ...
      <header className="mt-2">
        ...
        <div className="md:ml-40 md:bg-[#bde1f7] w-fit p-3">
          <h3 className=" font-bold text-lg md:text-xs">{currentQuestion.Dimension}</h3>
        </div>
      </header>
    </>
  );
